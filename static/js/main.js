...
$(function() {
  $('#search').keyup(function(){
    if(event.keyCode == 13){
      window.location = 'http://search.aol.com/aol/search?s_it=topsearchbox.search&v_t=na&q=site%3Ajiangjiazhi.com+' + $(this).val();
    }
  });
});
...
$(function(){
  if ($('.article-data').length){
    document.title = $('.article-title').text() + ' ---> by jjz'
